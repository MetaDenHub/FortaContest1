...
function executeCommand(commandName, cliArgs) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    diContainer = di_container_1.default(commandName, cliArgs);
                    command = diContainer.resolve(commandName);
                    return [4, command(cliArgs)];
                case 1:
                    _a.sent();
                    return [3, 3];
                case 2:
