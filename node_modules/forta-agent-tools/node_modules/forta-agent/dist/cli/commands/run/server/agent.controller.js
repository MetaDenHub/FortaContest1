...
var _a = require("../../../../sdk"), BlockEvent = _a.BlockEvent, TransactionEvent = _a.TransactionEvent;
var _b = require("../../../utils"), assertExists = _b.assertExists, formatAddress = _b.formatAddress;
module.exports = (function () {
    ...
    AgentController.prototype.EvaluateBlock = function (call, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var findings, status, blockEvent, _a, _b, _c, e_1;
    ...
    AgentController.prototype.EvaluateTx = function (call, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var findings, status, txEvent, _a, _b, _c, e_2;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        findings = [];
    ...
    AgentController.prototype.createBlockEventFromGrpcRequest = function (request) {
        var _a = request.event, type = _a.type, network = _a.network, blockHash = _a.blockHash, blockNumber = _a.blockNumber, block = _a.block;
        var blok = {
        ...
        return new BlockEvent(type, parseInt(network.chainId), blockHash, parseInt(blockNumber), blok);
    };
    AgentController.prototype.createTransactionEventFromGrpcRequest = function (request) {
        var _a = request.event, type = _a.type, network = _a.network, tx = _a.transaction, rcpt = _a.receipt, trcs = _a.traces, addresses = _a.addresses, block = _a.block;
        var transaction = {
            hash: tx.hash,
        ...
        var receipt = {
            ...
            logs: rcpt.logs.map(function (log) { return ({
        ...
        return new TransactionEvent(type, parseInt(network.chainId), transaction, receipt, traces, addresses, blok);
    };
