...
var getFortaConfig = function () {
    ...
    var configPath = path_1.join(process.cwd(), configFile || 'forta.config.json');
...
var createBlockEvent = function (_a) {
    var _b = _a.type, type = _b === void 0 ? _1.EventType.BLOCK : _b, _c = _a.network, network = _c === void 0 ? _1.Network.MAINNET : _c, blockHash = _a.blockHash, blockNumber = _a.blockNumber, block = _a.block;
    return new _1.BlockEvent(type, network, blockHash, blockNumber, block);
};
