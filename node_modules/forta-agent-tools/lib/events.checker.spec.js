...
var findingGenerator = function (event) {
    return forta_agent_1.Finding.fromObject({
        ...
        metadata: {
            topics: JSON.stringify(event === null || event === void 0 ? void 0 : event.topics),
            data: event === null || event === void 0 ? void 0 : event.data,
            address: event === null || event === void 0 ? void 0 : event.address,
        },
    });
};
describe("Event Checker Agent Tests", function () {
    ...
    it("should returns empty findings with filtered function", function () { return __awaiter(void 0, void 0, void 0, function () {
        var filterLog, txEvent, findings;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filterLog = function (log) {
                        var number = Number(BigInt(log.data)) / Math.pow(10, 18);
                        if (number > 2) {
                            return true;
                        }
                        return false;
                    };
                    transactionHandler = (0, events_checker_1.default)(tests_utils_1.generalTestFindingGenerator, EVENT_SIGNATURE, "0x121212", filterLog);
                    txEvent = new tests_utils_1.TestTransactionEvent().addEventLog(EVENT_SIGNATURE, "0x121212", "0x000000000000000000000000000000000000000000000000000eebe0b40e8000" // 0.0042
                    );
                    return [4 /*yield*/, transactionHandler(txEvent)];
                case 1:
                    findings = _a.sent();
    ...
    it("should returns findings with filtered function if condition met", function () { return __awaiter(void 0, void 0, void 0, function () {
        var filterLog, txEvent, findings;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    transactionHandler = (0, events_checker_1.default)(tests_utils_1.generalTestFindingGenerator, EVENT_SIGNATURE, "0x121212", filterLog);
                    txEvent = new tests_utils_1.TestTransactionEvent().addEventLog(EVENT_SIGNATURE, "0x121212", "0x00000000000000000000000000000000000000000000000029a2241af62c0000" // 3
                    );
                    return [4 /*yield*/, transactionHandler(txEvent)];
                case 1:
                    findings = _a.sent();
    ...
    it("should returns findings with metadata if condition met", function () { return __awaiter(void 0, void 0, void 0, function () {
        var filterLog, address, topics, data, txEvent, findings;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    address = "0x121212";
                    topics = ["0x10", "0x20", "0x30"];
                    data = "0x00000000000000000000000000000000000000000000000029a2241af62c0000";
                    transactionHandler = (0, events_checker_1.default)(findingGenerator, EVENT_SIGNATURE, address, filterLog);
                    txEvent = (_a = new tests_utils_1.TestTransactionEvent()).addEventLog.apply(_a, __spreadArray([EVENT_SIGNATURE,
                        address,
                        data], topics, false));
                    return [4 /*yield*/, transactionHandler(txEvent)];
                case 1:
                    ...
                    expect(findings).toStrictEqual([
                        findingGenerator({
                            topics: __spreadArray([(0, utils_1.keccak256)(EVENT_SIGNATURE)], topics, true),
                            address: address,
                            data: data,
                        }),
                    ]);
    ...
    it("should returns findings with metadata if the event was emitted", function () { return __awaiter(void 0, void 0, void 0, function () {
        var address, topics, data, txEvent, findings;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    topics = ["0xA", "0xB", "0xC"];
                    data = "0x00000000000000000000000000000000000000000000000029a2241af62c0000";
                    transactionHandler = (0, events_checker_1.default)(findingGenerator, EVENT_SIGNATURE, address);
                    txEvent = (_a = new tests_utils_1.TestTransactionEvent()).addEventLog.apply(_a, __spreadArray([EVENT_SIGNATURE,
                        address,
                        data], topics, false));
                    return [4 /*yield*/, transactionHandler(txEvent)];
