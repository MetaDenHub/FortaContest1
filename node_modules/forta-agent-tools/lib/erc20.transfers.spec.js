...
var createTransactionEventWithTransferLog = function (tokenAddress, from, to, amount) {
    var fromTopic = (0, utils_1.encodeParameter)("address", from);
    var toTopic = (0, utils_1.encodeParameter)("address", to);
    var data = (0, utils_1.encodeParameter)("uint256", amount);
    return new tests_utils_1.TestTransactionEvent().addEventLog("Transfer(address,address,uint256)", tokenAddress, data, fromTopic, toTopic);
};
