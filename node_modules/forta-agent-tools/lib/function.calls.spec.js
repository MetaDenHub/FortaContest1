...
describe("Function calls detector Agent Tests", function () {
    ...
    it("Should not break if no trace is passed", function () { return __awaiter(void 0, void 0, void 0, function () {
        var signature, txEvent, findings;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    signature = "Func()";
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    txEvent1 = new tests_utils_1.TestTransactionEvent().addTraces({
                ...
                case 1:
                    findings = _c.sent();
                    expect(findings).toStrictEqual([]);
                    txEvent2 = new tests_utils_1.TestTransactionEvent().addTraces({
                        to: (0, tests_utils_1.createAddress)("0x0"),
                        input: selector,
                    });
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 2:
                    ...
                    expect(findings).toStrictEqual([]);
                    txEvent3 = new tests_utils_1.TestTransactionEvent().addTraces({
                        from: (0, tests_utils_1.createAddress)("0x0"),
                ...
                case 3:
                    ...
                    expect(findings).toStrictEqual([]);
                    txEvent4 = new tests_utils_1.TestTransactionEvent().addTraces({
                        from: (0, tests_utils_1.createAddress)("0x1"),
                        to: (0, tests_utils_1.createAddress)("0x2"),
                        input: selector,
                    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    input = abi.encodeFunctionCall(signature, ["2345675643", "Hello!%"]);
                    to = (0, tests_utils_1.createAddress)("0x1");
                    ...
                    txEvent = new tests_utils_1.TestTransactionEvent().addTraces({ to: to, from: from, input: input });
                    return [4 /*yield*/, handleTransaction(txEvent)];
                case 1:
                    findings = _a.sent();
