...
describe("ETH Transfer Agent Tests", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    txEvent = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("9"));
    ...
    it("should returns empty findings if no threshold was specified and transactions are 10 ETH or more", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    handleTransaction = (0, eth_transfers_1.default)(tests_utils_1.generalTestFindingGenerator);
                    txEvent1 = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("10"));
                    return [4 /*yield*/, handleTransaction(txEvent1)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([(0, tests_utils_1.generalTestFindingGenerator)()]);
                    txEvent2 = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("100"));
    ...
    it("should returns empty findings if value is under specified threshold", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    handleTransaction = (0, eth_transfers_1.default)(tests_utils_1.generalTestFindingGenerator, { valueThreshold: (0, web3_utils_1.toWei)("100") });
                    txEvent = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("99"));
                    return [4 /*yield*/, handleTransaction(txEvent)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([]);
    ...
    it("should returns findings if value is equal or greater to specified threshold ", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    handleTransaction = (0, eth_transfers_1.default)(tests_utils_1.generalTestFindingGenerator, { valueThreshold: (0, web3_utils_1.toWei)("100") });
                    txEvent1 = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("100"));
                    return [4 /*yield*/, handleTransaction(txEvent1)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([(0, tests_utils_1.generalTestFindingGenerator)()]);
                    txEvent2 = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("1000"));
                    return [4 /*yield*/, handleTransaction(txEvent2)];
                case 2:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([(0, tests_utils_1.generalTestFindingGenerator)()]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    txEvent = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("15")).setFrom((0, tests_utils_1.createAddress)("0x13"));
                    return [4 /*yield*/, handleTransaction(txEvent)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([]);
    ...
    it("should returns findings if transactions are from the specified address", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    handleTransaction = (0, eth_transfers_1.default)(tests_utils_1.generalTestFindingGenerator, { from: (0, tests_utils_1.createAddress)("0x12") });
                    txEvent = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("15")).setFrom((0, tests_utils_1.createAddress)("0x12"));
                    return [4 /*yield*/, handleTransaction(txEvent)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([(0, tests_utils_1.generalTestFindingGenerator)()]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    txEvent = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("15")).setTo((0, tests_utils_1.createAddress)("0x13"));
                    return [4 /*yield*/, handleTransaction(txEvent)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([]);
    ...
    it("should returns findings if transactions are to specified address", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    handleTransaction = (0, eth_transfers_1.default)(tests_utils_1.generalTestFindingGenerator, { to: (0, tests_utils_1.createAddress)("0x12") });
                    txEvent = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("15")).setTo((0, tests_utils_1.createAddress)("0x12"));
                    return [4 /*yield*/, handleTransaction(txEvent)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([(0, tests_utils_1.generalTestFindingGenerator)()]);
            ...
            switch (_a.label) {
                case 0:
                    handleTransaction = (0, eth_transfers_1.default)(tests_utils_1.generalTestFindingGenerator, {
                        ...
                        valueThreshold: (0, web3_utils_1.toWei)("50"),
                    });
                    txEvent1 = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("100")).setTo((0, tests_utils_1.createAddress)("0x13"));
                    return [4 /*yield*/, handleTransaction(txEvent1)];
                case 1:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([]);
                    txEvent2 = new tests_utils_1.TestTransactionEvent().setValue((0, web3_utils_1.toWei)("100")).setFrom((0, tests_utils_1.createAddress)("0x12"));
                    return [4 /*yield*/, handleTransaction(txEvent2)];
                case 2:
                    findings = _a.sent();
                    expect(findings).toStrictEqual([]);
                    txEvent3 = new tests_utils_1.TestTransactionEvent()
                        .setValue((0, web3_utils_1.toWei)("40"))
                ...
                case 3:
                    ...
                    txEvent4 = new tests_utils_1.TestTransactionEvent()
                        .setValue((0, web3_utils_1.toWei)("80"))
                        .setFrom((0, tests_utils_1.createAddress)("0x12"))
                        .setTo((0, tests_utils_1.createAddress)("0x13"));
