...
var fromLogToTransferInfo = function (log) {
    return {
        to: (0, utils_1.decodeParameter)("address", log.topics[2]),
        from: (0, utils_1.decodeParameter)("address", log.topics[1]),
        amount: (0, utils_1.decodeParameter)("uint256", log.data),
    };
};
...
function provideERC20TransferHandler(findingGenerator, tokenAddress, agentOptions) {
    var _this = this;
...
exports.default = provideERC20TransferHandler;
